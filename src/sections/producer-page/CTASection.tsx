...
export const ProducerCTASection = () => {
  return (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-2xl mx-auto leading-relaxed">
              ...
              Une programmation sur mesure pour des événements inoubliables.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              >
                ...
                <span className="relative font-bold text-white text-lg">Commencer la discussion</span>
                <motion.div
                  className="relative"
                  animate={{ x: [0, 4, 0] }}
              ...
              >
                ...
                <span className="font-semibold text-white group-hover:text-glow transition-all duration-300">Voir tous nos artistes</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
              ...
              >
                ...
                <p className="text-sm text-white/70">Un interlocuteur dédié pour votre projet</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-white/70">95% de spectacles complets</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
